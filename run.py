...
def main():
    ...
    agents_json = json.dumps({
        "Orchestrator": {
            "description": "Orchestrator — 编排多个Agent解决积分题目",
